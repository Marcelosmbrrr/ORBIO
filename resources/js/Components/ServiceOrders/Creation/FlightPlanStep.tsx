...
export const FlightPlanStep: React.FC<{
    selection: { id: string }[];
    setData: Function;
}> = ({ selection, setData }) => {
        ...
        (e: React.ChangeEvent<HTMLInputElement>) => {
            ...
            if (recordIndex !== -1) {
                ...
                const record = data.find(
                    (flightplan: any) => flightplan.id === selectedRecordId
                );
                if (record) {
