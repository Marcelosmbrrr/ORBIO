...
export function ProfileAddressData() {
    ...
    return (
        <form
            className="p-5 row-span-2 rounded-lg bg-white shadow dark:bg-gray-800"
            onSubmit={submit}
        >
            ...
            <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                <div className="w-full">
                    ...
                    <div className="relative">
                        ...
                        />
                        <div
                            className="absolute inset-y-0 right-0 flex items-center px-3 cursor-pointer bg-blue-500 rounded-r-lg hover:bg-blue-600"
