...
export function ProfileBasicData() {
    ...
    const { data, setData, patch, processing, errors, setDefaults } = useForm({
        ...
        <form className="p-5 rounded-lg bg-white shadow dark:bg-gray-800" onSubmit={submit}>
            ...
            <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div className="w-full">
                    ...
                    <input type="email" value={data.email} onChange={e => setData('email', e.target.value)} id="email" className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:placeholder-neutral-300 dark:bg-gray-700 dark:border-gray-800 dark:text-neutral-400 dark:focus:ring-blue-600" placeholder="Informe o e-mail" />
            ...
            <div className='text-right'>
                <button disabled={processing} type="button" className="mt-3 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
