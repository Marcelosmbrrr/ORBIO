...
export default function Drones() {
    ...
    function handleExportTableData() {
        exportDataAsCsv("drones", pagination.data, {
            status: {
                is_object: true,
                get: "title",
            },
    ...
    return (
        <AuthenticatedLayout>
            <div className="flex flex-col h-full">
                <Breadcrumb items={["Equipamentos", "Drones"]} />
    ...
    <div className="flex justify-start md:justify-end flex-shrink-0 w-full md:w-auto md:flex-row md:space-y-0 md:items-center space-x-1">
        {canCreate && (
            <Button
                ...
                text="Criar"
                icon={PlusIcon}
                onClick={() => router.get(route("drones.create"))}
                processing={false}
            />
        )}
