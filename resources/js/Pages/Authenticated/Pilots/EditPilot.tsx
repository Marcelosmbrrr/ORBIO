...
export default function EditPilot({ user }: any) {
    ...
    const submit: React.FormEventHandler = (e) => {
        e.preventDefault();
        patch("/pilots/" + user.id, {
            onError: () => {
                enqueueSnackbar("Erro ao editar o piloto!", { variant: "error" });
            }
        });
    };
        ...
        <AuthenticatedLayout>
            ...
            <section>
                <div className="py-8 mx-auto max-w-7xl lg:py-16">
                    <h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-white">Editar Piloto</h2>
                    <form onSubmit={submit}>
                        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div className="sm:col-span-2">
                                <div className='mb-2'>
                                    ...
                                    <span className='text-gray-400 text-sm'>A senha pode ser informada irá substituir a atual.</span>
                                </div>
                        ...
                        <div className='flex justify-end py-3'>
                            <Link href={route('pilots.index')} className="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-900 dark:text-white dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                Voltar
                            </Link>
