...
export default function ShowClient({ client }: any) {
    return (
        <AuthenticatedLayout>
            <Breadcrumb items={["Usúarios", "Clientes", "Visualizar"]} />
            <section>
                        ...
                        <div className="grid gap-4 sm:grid-cols-6 sm:gap-6">
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <Input
                                    readOnly
                                    type="text"
                                    value={client.data.status.title}
                                    id="status"
                                />
                            </div>
                            <div className="sm:col-span-2">
