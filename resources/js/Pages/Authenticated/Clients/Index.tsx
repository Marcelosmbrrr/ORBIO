        ...
        <AuthenticatedLayout>
            <div className='flex flex-col h-full'>
                ...
                <div className='grow py-5 rounded'>
                    ...
                    <ClientTable clients={clients} isSelected={isSelected} toggleSelection={toggleSelection} />
...
const ClientTable = ({ clients, isSelected, toggleSelection }: any) => (
    <div className="mt-2 overflow-x-auto sm:rounded-lg">
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                {clients.length > 0 ? clients.map((client: ClientRecord) => (
