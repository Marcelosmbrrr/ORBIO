...
export default function CreateReport() {
    ...
    const handleSubmit = async () => {
        ...
        const file = new File([blob], `${getValues("name")}.pdf`, {
    ...
    return (
        <AuthenticatedLayout>
            <Breadcrumb items={["Ordens de Serviço", "Relatórios", "Criar"]} />
            <section>
                <div className="mx-auto mt-10">
                    ...
                    <div className="mt-5">
                        ...
                        {step === 2 && (
                            <LogSelectionStep logs={logs} setLogs={setLogs} />
                        )}
                        {step === 3 && (
                            <ImagesAndMetereologicalDataStep logs={logs} />
                        )}
                        {step === 4 && (
                            <div>
                                <div className="mb-5">
                                    ...
                                    <p className="text-gray-500 dark:text-gray-400">
                                        ...
                                        clique em "Ver Relatório". Depois de
                                        revisá-lo, clique em "Confirmar" para
                                        salvar o documento.
                                    </p>
                                </div>
                                <ReportVisualization
...
const FormStep: React.FC<FormStepProps> = ({
    ...
    <>
        <div className="mb-5">
            <p className="text-gray-500 dark:text-gray-400">
                Preencha todos os dados do formulário abaixo.
            </p>
        </div>
        <div className="grid gap-4 my-5 grid-cols-1 md:grid-cols-2">
            ...
            <div>
                ...
                <span className="text-red-500 text-sm">
                    {errors.client ? String(errors.client.message) : ""}
                </span>
            </div>
            <div>
                <label
                ...
                <span className="text-red-500 text-sm">
                    {errors.pilot ? String(errors.pilot.message) : ""}
                </span>
            </div>
            <div>
                <label
            ...
            <div>
                ...
                />
                <span className="text-red-500 text-sm">
                    {errors.farm ? String(errors.farm.message) : ""}
                </span>
            </div>
            <div>
                <label
                ...
                />
                <span className="text-red-500 text-sm">
                    {errors.provider ? String(errors.provider.message) : ""}
                </span>
            </div>
            <div>
                <label
                ...
                <input
                    ...
                    {...register("area")}
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Informe a área total aplicada"
                />
                <span className="text-red-500 text-sm">
                    {errors.area ? String(errors.area.message) : ""}
                </span>
            </div>
            <div>
                <label
                ...
                <input
                    ...
                    readOnly
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Informe o número da aplicação"
                />
                <span className="text-red-500 text-sm">
                    {errors.application_number
                        ? String(errors.application_number.message)
                        : ""}
                </span>
            </div>
            <div>
                ...
                />
                <span className="text-red-500 text-sm">
                    {errors.dosage ? String(errors.dosage.message) : ""}
                </span>
            </div>
            <div>
                <label
                ...
                <input
                    ...
                    {...register("date")}
                    id="date"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-auto p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                />
                <span className="text-red-500 text-sm">
                    {errors.date ? String(errors.date.message) : ""}
                </span>
            </div>
        </div>
    </>
