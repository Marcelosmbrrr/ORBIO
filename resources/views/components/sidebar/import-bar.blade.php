<div>
    <div id="import-file-bar" class="w-60 h-screen py-3 overflow-y-auto bg-white border-l border-r dark:bg-gray-900 dark:border-gray-700 transition-all hidden">
        <div>
